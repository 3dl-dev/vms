...
# cross-compile) built on tools/cross-vax/build-vmsfs-core-vax.sh's VAX pattern
...
# .c) where it cannot build -- exactly as build-vmsfs-core-vax.sh generates its
# width-audit TU. See docs/audit-ilp32-vax-netbsd-exec.md sec 1-3.
