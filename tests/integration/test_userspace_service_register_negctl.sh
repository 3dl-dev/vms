...
# The id every minted fictional declaration cites. Kept as a label distinct
# from any real tree id purely so a control's fixture cannot be confused with
# real tree state; nothing resolves or verifies it any more (rd vms-dc7).
