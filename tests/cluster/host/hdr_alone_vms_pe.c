...
/*
 * hdr_alone_vms_pe.c - vms_pe.h, alone, from a blank slate (FC-P0.1).
 *
 * This translation unit's ONLY project #include is vms_pe.h. If vms_pe.h
...
int ovmx_hdr_alone_vms_pe(void);
int ovmx_hdr_alone_vms_pe(void)
{
	return 0;
}
