...
Every figure quoted in docs/cluster-protocol-spec.md sec 4(h)(1e) and sec 5
...
(D) THE CREDIT ACCOUNT -- the part that answers the constant-1 lead.
    *VAXcluster Principles* pp. 2-43..2-44 (quoted with page cites in
    ...
    It does NOT restore lead (i). See sec 4(h)(1e) and sec 5 for the two
...
# docs/cluster-protocol-spec.md sec 4(h)(1e) / sec 5, and
