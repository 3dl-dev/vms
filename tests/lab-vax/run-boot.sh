...
SINGLE_A_SECTORS="${SINGLE_A_SECTORS:-409600}"      # root FFS: 200 MiB
SINGLE_TOTAL_SECTORS="${SINGLE_TOTAL_SECTORS:-547120}"  # slim disk: RAUSER=280
SINGLE_RQ0_TYPE="${SINGLE_RQ0_TYPE:-RAUSER=280}"    # ~267 MiB MSCP disk
