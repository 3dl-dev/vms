...
# exercised in this tree: control 20's collision target ($COLLIDE=no_such_product_function_xyz)
...
if ! grep -rl "[^A-Za-z0-9_]${COLLIDE}[ 	]*(" "$ROOT/src" --include='*.c' 2>/dev/null \
    ...
    tally_category "an unwired wrapper renamed onto a product function's name is NOT credited to it" "bogus"
