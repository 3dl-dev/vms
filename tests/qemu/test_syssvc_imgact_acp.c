 ...
 * harness seeds on DKA300: (vdd, from tests/qemu/mkimage_ods2_imgact.c):
 *
 *   1. OPEN BY FILESPEC + DIRECTORY WALK. imgact_acp_open("DKA300:",
...
/* DKA300: (vdd) carries the generated ODS-2 fixture with [IMGACT]TESTIMG.EXE. */
#define ODS2_UNIT   "DKA300:"
