...
/*
 * hdr_alone_vms_scs.c - vms_scs.h, alone, from a blank slate (FC-P0.1).
 *
 * This translation unit's ONLY project #include is vms_scs.h. If vms_scs.h
...
int ovmx_hdr_alone_vms_scs(void);
int ovmx_hdr_alone_vms_scs(void)
{
	return 0;
}
