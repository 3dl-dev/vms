...
/*
** This program demonstrates lib$addx () which will add multiple precision
...
** input to lib$addx can be any size.
*/
...
static __int64 check3;
    ...
    check1 = 0x0000222200001111;
    check2 = 0x0000444400003333;
