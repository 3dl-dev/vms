...
/*
 * hdr_alone_vms_cluster.c - vms_cluster.h, alone, from a blank slate (FC-P0.1).
 *
 * This translation unit's ONLY project #include is vms_cluster.h. If vms_cluster.h
...
int ovmx_hdr_alone_vms_cluster(void);
int ovmx_hdr_alone_vms_cluster(void)
{
	return 0;
}
